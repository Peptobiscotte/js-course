...
allSections.forEach(function (section) {
  ...
  section.classList.add('section--hidden') // ⚠️ réétablir
})

// -lazy loading images
const imgTargets = document.querySelectorAll('img[data-src]') // on selectionne uniquement les images
// ayant le data attributes src
...
// COURSE 198 revealing elem on scroll.

// COURSE 199 Lazy loading images

// COURSE 200 Slider component

// COURSE 202 Lifecycle DOM events
...
//   console.log('Page loaded', e) // event au loading
// })

// window.addEventListener('beforeunload', function (e) { // event juste avant de quitter la page.
//   e.preventDefault() // exemple petite croix
//   e.returnValue = ''
// })

// COURSE 203 Efficient script loading
